...
export function mossChecker() {
    if (storage.gameData.mossUnlocked) {
		...
		if (storage.gameData.mossFactorPow.greaterThan(new Decimal(1))) {
...
export function mossMilestoneChecker() {
    ...
    if (storage.gameData.mossUnlocked) {
        ...
        if (storage.gameData.moss.greaterThanOrEqualTo(mossMilestoneCost.MM11)) {
...
export function M1CostCalculation() {
    ...
    if (y.greaterThanOrEqualTo(new Decimal(20))) {
		...
		if (y.greaterThan(new Decimal(100000))) {
...
export function M2CostCalculation() {
    ...
    const w = x.pow(z);
    if (y.greaterThanOrEqualTo(new Decimal(10))) {

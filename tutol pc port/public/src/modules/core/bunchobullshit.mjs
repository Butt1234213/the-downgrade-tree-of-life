...
import { hasInitialized, saveLoop } from '../savefile.mjs';
...
document.getElementById("loadFirstHarvest").addEventListener("click", loadFirstHarvest);
document.getElementById("loadMossUnlock").addEventListener("click", loadMossUnlocked);
document.getElementById("loadFirstTransformation").addEventListener("click", loadFirstTransformation);
document.getElementById("loadStormUnlock").addEventListener("click", loadStormUnlocked);
document.getElementById("loadWildfireUnlock").addEventListener("click", loadWildfireUnlocked);
document.getElementById("loadDroughtUnlock").addEventListener("click", loadDroughtUnlocked);
document.getElementById("loadBlizzardUnlock").addEventListener("click", loadBlizzardUnlocked);

...
export function rootMilestoneChecker() {
	if (storage.gameData.reinforcements.gte(new Decimal(1))) {
		...
		if (storage.gameData.reinforcements.gte(storage.rootUpgradeCost.RM1)) {
		...
		if (storage.gameData.reinforcements.gte(storage.rootUpgradeCost.RM2)) {
		...
		if (storage.gameData.reinforcements.gte(storage.rootUpgradeCost.RM3)) {
		...
		if (storage.gameData.reinforcements.gte(storage.rootUpgradeCost.RM4)) {
		...
		if (storage.gameData.reinforcements.gte(storage.rootUpgradeCost.RM5)) {
		...
		if (storage.gameData.reinforcements.gte(storage.rootUpgradeCost.RM6)) {
		...
		if (storage.gameData.reinforcements.gte(storage.rootUpgradeCost.RM7)) {
		...
		if (storage.gameData.reinforcements.gte(storage.rootUpgradeCost.RM8)) {
		...
		if (storage.gameData.reinforcements.gte(storage.rootUpgradeCost.RM9)) {
		...
		if (storage.gameData.reinforcements.gte(storage.rootUpgradeCost.RM10)) {
		...
		if (storage.gameData.reinforcements.gte(storage.rootUpgradeCost.RM11)) {
